...
effect with some chance of variation.
  ...
  - What is the difference between 1-Sample T-test, and 2-Sample T-test?
      ...
      - T-Tests for comparing **means**. Each test that you perform on
        your sample data, brings down your sample data to a single value
        i.e. T-value.

Types of tests:

  - T-test: T-test is used when the standard deviation is unknown and
    the sample size is comparatively small.
  - Chi-Square Test for Independence: These tests are used to find out
    the significance of the association between categorical variables in
  ...
  - Analysis of Variance (ANOVA): This kind of hypothesis testing is
    ...
    This test is often used similarly to a T-test but, is used for more
    than two groups.
  - Welch’s T-test: This test is used to find out the test for equality
    of means between two population samples.

Types of tests:

  - Parametric -\> gaussian assumption
  - Non-parametric
      - 1-sample Wilcoxon signed rank test. With this test, you also
        estimate the population median and compare it to a
