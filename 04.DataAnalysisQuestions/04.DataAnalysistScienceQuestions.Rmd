...
It essentially helps to assess the statistical significance of insight by determining the odds of the results occurring **by chance**. The first thing is to know the null hypothesis and then state it. Then the p-value is calculated, and if the null hypothesis is true, other values are also determined. 
