...
* The ct column names are the unpivoted column (Gender) and the unique values of the pivoted column (2008 and 2012). Make sure to surround the years with double quotes when listing them as column names.
